...
public class RoundAnglePictureImageView extends ImageView {
	...
	public RoundAnglePictureImageView(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public RoundAnglePictureImageView(Context context) {
		super(context);
		init(context, null);
	}
